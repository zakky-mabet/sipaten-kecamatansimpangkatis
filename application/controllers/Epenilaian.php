...
class Epenilaian extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data = array(
            'title' => 'E-Penilaian - KISS - Koba District Information And Service Center - Kabupaten Bangka Tengah',
            'crumb' => 'Epenilaian'  
            );
    ...
    public function nilai($param=0)
    {
        ...
        $data = array(
            'title' => 'Beri Penilaian - KISS - Koba District Information And Service Center - Kabupaten Bangka Tengah',
    ...
    {
        $data = array(
            'title' => 'Penilaian Pengaduan - KISS - Koba District Information And Service Center - Kabupaten Bangka Tengah',
    ...
    {
        $data = array(
            'title' => 'Penilaian Pelayanan - KISS - Koba District Information And Service Center - Kabupaten Bangka Tengah',
  ...
  {
            $data = array(
            'title' => 'Panduan Penilaian - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
   ...
   public function read($slug = '')
  {
             ...
             $data = array(
                'title' => 'Detail Panduan Penilaian - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
