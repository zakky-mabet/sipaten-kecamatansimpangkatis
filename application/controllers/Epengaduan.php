...
class Epengaduan extends CI_Controller {
    ...
    {
        $data = array(
            'title' => 'E-pengaduan - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
            'crumb' => 'E-pengaduan'  
            );
    ...
    {
        $data = array(
            'title' => 'Buat Pengaduan - Epengaduan - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
    ...
    {
        $data = array(
            'title' => 'Riwayat Pengaduan- KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
    ...
    {
        $data = array(
            'title' => 'Histori - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
   ...
   public function detail($ID=0){
        ...
        $data = array(
            'title' => 'Detail pengaduan - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
   ...
   public function edit($ID=0){
        ...
        $data = array(
            'title' => 'Edit pengaduan - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
  ...
  {
            $data = array(
            'title' => 'Panduan Pengaduan - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
   ...
   public function read($slug = '')
  {
             ...
             $data = array(
                'title' => 'Detail Panduan Pengaduan - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
