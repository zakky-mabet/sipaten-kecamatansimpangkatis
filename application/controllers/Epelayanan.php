...
class Epelayanan extends CI_Controller {
	...
	{
		$data = array(
			'title' => 'E-Pelayanan - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
			'crumb' => 'E-Pelayanan',
	...
	{
		$data = array(
			'title' => 'Riwayat Pelayanan - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
	...
	{
		$data = array(
			'title' => 'Surat Keterangan Tidak Mampu - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
	...
	{
		$data = array(
			'title' => 'Surat Keterangan Kelakuan Baik - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
	...
	{
		$data = array(
			'title' => 'Surat Rekomendasi Keterangan Usaha  - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
	...
	{
		$data = array(
			'title' => 'Surat Rekomendasi Izin Gangguan  - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
	...
	{
		$data = array(
			'title' => 'Surat Rekomendasi Perpanjangan Izin Operasional  - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
	...
	{
		$data = array(
			'title' => 'Surat Rekomendasi Izin Keramaian  - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
	...
	{
		$data = array(
			'title' => 'Surat Keterangan Domisili Perusahaan  - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
	...
	{
		$data = array(
			'title' => 'Surat Izin Usaha Mikro Dan Kecil  - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
	...
	{
		$data = array(
			'title' => 'Surat Keterangan Bersih Lingkungan Keluarga  - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
	...
	{
		$data = array(
			'title' => 'Surat Keterangan Waris  - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
	...
	{
		$data = array(
			'title' => 'Surat Rekomendasi Izin Usaha Perdagangan  - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
	...
	{
		$data = array(
			'title' => 'Surat Keterangan Tinggal Sementara  - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
	...
	{
		$data = array(
			'title' => 'Surat Izin Mendirikan Bangunan  - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
     ...
     public function sp3fat(){
		$data = array(
			'title' => ' Surat Pernyataan Pengakuan Penguasaan Fisik Atas Tanah  - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
    ...
    public function sp4fat(){
		$data = array(
			'title' => ' Surat Pernyataan Pelepasan dan Penyerahan Penguasaan Fisik Atas Tanah  - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
	...
	{
		$data = array(
			'title' => 'Surat Keterangan Pindah Jiwa  - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
	...
	{
		$data = array(
			'title' => 'Surat Keterangan Pindah WNI  - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
	...
	public function edit($ID=0)
	{
        ...
        if ($rowcek->kode_surat == TRUE AND $rowcek->status == 'no') {
        	switch ($rowcek->kode_surat_sistem) {
			    case 10: //imk
						...
						$this->form_validation->set_rules('nomor_pendaftaran', 'Nomor Pendaftaran Perusahaan', 'trim|required');
				        $data = array(
				            'title' => 'Edit Surat Izin Usaha Mikro dan Kecil - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
        ...
        else
        {
	         ...
	         if (isset($_FILES['skkb_3'])) 
	        {
			    ...
			    case 19: // skw
			    	$data = array(
					'title' => 'Edit Surat Keterangan Waris  - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
	        ...
	        if (isset($_FILES['skw_4'])) 
	        {
			    ...
			    case 3: // kst
			    $data = array(
				'title' => ' Edit Surat Keterangan Tinggal Sementara  - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
		...
		$this->form_validation->set_rules('pekerjaan_penanggung', 'Pekerjaan Penanggung', 'trim|required');
	        ...
	        if (isset($_FILES['kts_4'])) 
	        {
			    ...
			    case 2: // kdp
			    	$data = array(
						'title' => 'Edit Surat Keterangan Domisili Perusahaan  - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
			    ...
			    case 1: // kpj
			    	$data = array(
				'title' => 'Edit Surat Keterangan Pindah Jiwa  - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
	        ...
	        if (isset($_FILES['kpj_4'])) 
	        {
			    ...
			    case 12: // srku
			    	$data = array(
						'title' => 'Edit Surat Rekomendasi Keterangan Usaha  - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
			    ...
			    case 5: // sbl
					$data = array(
					'title' => 'Edit Surat Keterangan Bersih Lingkungan Keluarga  - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
        	...
        	if (isset($_FILES['sbl_3'])) 
	        {
			    ...
			    case 7 : // siup
			    	$data = array(
			'title' => 'Edit Surat Rekomendasi Izin Usaha Perdagangan  - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
        ...
        if ($this->form_validation->run() == FALSE)
        {
          $this->template->view('main/pelayanan/edit/v_siup_edit', $data);
			...
			case 9: // imb    
			    	$data = array(
			'title' => 'Edit Surat Izin Mendirikan Bangunan  - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
        ...
        } else
        {
	         ...
	         if (isset($_FILES['imb_10'])) 
	        {
			    ...
			    case 11: // srig
			    	$data = array(
			'title' => ' Edit Surat Rekomendasi Izin Gangguan  - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
        ...
        else
        {
	        ...
	        if (isset($_FILES['srig_7'])) 
	        {
			    ...
			    case 13: // rpio
			    	$data = array(
			'title' => ' Edit Surat Rekomendasi Perpanjangan Izin Operasional  - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
			...
			'title' => 'Edit Surat Pernyataan Pengakuan Penguasaan Fisik Atas Tanah  - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
			...
			'title' => 'Edit Surat Pernyataan Pelepasan dan Penyerahan Penguasaan Fisik Atas Tanah - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
	        ...
	        if (isset($_FILES['sp4fat_2'])) 
	        {
			    ...
			    case 4:
			    	$data = array(
			'title' => 'Edit Surat Keterangan Pindah WNI  - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
	...
	public function detail($ID=0){
        ...
        $data = array(
            'title' => 'Detail Permohonan Pelayanan - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
  ...
  {
            $data = array(
            'title' => 'Panduan Pelayanan - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
   ...
   public function read($slug = '')
  {
             ...
             $data = array(
                'title' => 'Detail Panduan Pelayanan - KISS Koba District Information And Service Center - Kecamatan Koba - Kabupaten Bangka Tengah',
