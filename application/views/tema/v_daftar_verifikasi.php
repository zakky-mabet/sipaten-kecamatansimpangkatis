			   ...
			   <?php echo $this->session->flashdata('pesan'); ?>
				...
				?>
			      ...
			      <div class="form-group has-feedback">
			        ...
			        <span class=" bg-orange fa fa-code form-control-feedback"></span>
			      ...
			      <div class="row">
			 	  ...
			 	  <div class="col-md-12">
			          <button type="submit" class="btn radius  btn-default bg-orange btn-block btn-flat ">Verifikasi</button>
			        </div>
