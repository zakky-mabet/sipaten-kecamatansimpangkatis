...
<head>
  ...
  <title>
    <?php echo (isset($data['title']) ? $data['title']." - KISS Koba District Information And Service Center" : "KISS - Kecamatan Koba Kabupaten Bangka Tengah") ?>
  </title>
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    ...
    <small>
      Hak Cipta &copy; 2017 <?php if(date('Y')!=2017) echo "- ".date('Y'); ?> Kec. Koba, Kab. Koba All rights reserved. Develop By <a href="http://teitramega.co.id" target="_blank">Teitra Mega</a>.
    <small>
  </footer>
