...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/dist/css/skins/tempayan_skin_portal.css') ?>">
  ...
  <?php } else { ?>
      <style type="text/css">
     body { 
    background-image: url('<?php echo base_url() ?>assets/img/bg-big.jpg') ;
    background-attachment: fixed;
    background-repeat: no-repeat;
    -webkit-background-size: cover;
    -moz-background-size: cover;
    ...
    <nav class="navbar navbar-fixed-top gradient" style="border-bottom: 1.2pt solid yellow; box-shadow: 5px 0px 5px" >
      <div class="container">
       ...
       <div class="navbar navbar-btn ">
              <ul class="nav navbar-nav navbar-right" style=" border-radius: 5px 5px 5px 5px;">
                <li class="color-black " ><a href="<?php echo base_url()?>" class=" fontmenu "><span class="fa fa-home "></span> Beranda</a></li>
                <?php  
              if ( $this->session->userdata('user_login') == FALSE ) : ?>
               <li><a href="<?php echo base_url()?>login" class=" fontmenu "><span class="fa fa-sign-in"></span> Login</a></li>
...
?>
       Copyright <?php $thn = ( date("Y") == 2017 ) ? date('Y') : '2017-'.date("Y"); echo '&copy; '.$thn; ?> <span>Kec.Simpang Katis Bangka Tengah</span>  
        <br>
          <p style="margin:-6px; font-size:0.8em; line-height: 20px">&nbsp;&nbsp;<?php echo ($this->agent->is_mobile()) ? '' :'Developed by : <a target="_blank" href="http://www.teitramega.co.id/">CV. Teitra Mega</a>';?></p>
          <p style="margin:-6px; font-size:0.8em; line-height: 20px">&nbsp;&nbsp;<?php echo ($this->agent->is_mobile()) ? 'Developed by : Developed by : <a target="_blank href="http://www.teitramega.co.id/">CV. Teitra Mega</a>' :'';?></p>
