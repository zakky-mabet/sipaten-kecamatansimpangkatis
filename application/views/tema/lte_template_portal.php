      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <div style="float: left; margin-top: 3px;">  
              ...
              <br> 
              <div style="margin-top: -10px; font-size: 0.8em;" class="white">&nbsp;&nbsp;&nbsp;&nbsp; Simpangkatis District Informations  <!--And  Service Center  --></div>
          </div>
...
?>
       Copyright <?php $thn = ( date("Y") == 2017 ) ? date('Y') : '2017-'.date("Y"); echo '&copy; '.$thn; ?> <span>Kec.Simpangkatis Bangka Tengah</span>  
        <br>
          ...
          <p style="margin:-6px; font-size:0.8em; line-height: 20px">&nbsp;&nbsp;<?php echo ($this->agent->is_mobile()) ? 'Developed by : Developed by : <a href="https://www.facebook.com/teitramega">CV. Teitra Mega</a>' :'';?></p>
