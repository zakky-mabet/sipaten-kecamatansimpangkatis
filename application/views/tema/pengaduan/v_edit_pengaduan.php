    ...
    <div class="box-header with-border ">
      ...
      <div class="box-body" style="margin-top: 10px;">
       <?php 
        ...
        redirect('epengaduan/histori','refresh');
            ...
            foreach ($edit_pengaduan as $value) { ?>
             <form action="<?php echo site_url('epengaduan/edit/'.$value->ID);  ?>"  class="form-horizontal"  method="post" accept-charset="utf-8" enctype="multipart/form-data"/>
        <div class="form-group">
          <label class="control-label col-md-3 col-xs-12">Judul : <strong class="text-red">*</strong></label>
          <div class="col-md-8">
            <input type="text" name="judul"  value="<?php echo $value->judul ?>" class="form-control" style="width: 100%;">
        ...
        <div class="form-group">
          ...
          <div class="col-md-8">
            <textarea name="pesan" rows="7"  class="form-control" style="width: 100%;"><?php echo $value->pesan ?></textarea>
        ...
        <div class="form-group">
          ...
          <div class="col-md-8">
            <textarea name="lokasi" rows="3"  class="form-control" style="width:100%;"><?php echo $value->pesan ?></textarea>
        ...
        <div class="form-group">
          ...
          <div class="col-md-8">
             <input onchange="previewFile()" name="photo" required type="file" value="<?php echo set_value('photo') ?>" class=" form-control " style="width: 100%;"><br>
      ...
      <div class="box-footer with-border">
        <div class="col-md-4 col-xs-5">
          <a href="<?php echo base_url('epengaduan/histori'); ?>" class="btn btn-app pull-right">
