<div <?php echo ($this->agent->is_mobile()) ? 'class="container margin-container" style="padding-top:50px;"' : $browser ="style='padding-top:80px;' class='container'" ; ?>>
 ...
 <div class="row">
  ...
  <div class="box-body">
    <div class="col-md-12">
      <div class="row">
            ...
            <br>
      <form action="<?php base_url('epelayanan/sskb') ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
   

  <div class="col-sm-12">
  <br>
      <p>
      Yang bertanda tangan di bawah ini Camat Kecamatan Simpangkatis Kabupaten Bangka Tengah, dengan ini menerangkan bahwa :
      </p>
  </div>
  ...
  <div class="col-sm-12">
      ...
      <h4 class="text-green">Persyaratan Pembuatan Surat Keterangan Kelakuan Baik :</h4>
        <thead >
          <tr >
