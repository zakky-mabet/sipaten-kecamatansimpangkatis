<div <?php echo ($this->agent->is_mobile()) ? 'class="container margin-container" style="padding-top:50px;"' : $browser ="style='padding-top:80px;' class='container'" ; ?>>
 ...
 <div class="row">
  ...
  <br>
      <p>
      Yang bertanda tangan di bawah ini Camat Kecamatan Koba Kabupaten Bangka Tengah, dengan ini menerangkan bahwa :
      </p>
  </div>
  ...
  <br>
     ...
     Sepanjang sepengetahuan kami bahwa nama tersebut adalah benar berkelakuan baik dalam kehidupan sehari-hari dan dalam kehidupan bermasyarakat.
      ...
      <p>
      Demikiaan, Surat Keterangan Baik ini dibuat, sebagai pengantar untuk melengkapi persyaratan "<span class="text-orange" id="needed"></span>".
  ...
  <div class="col-sm-12">
      ...
      <h4 class="text-orange">Persyaratan Pembuatan Surat Keterangan Kelakuan Baik :</h4>
        <thead >
          <tr >
