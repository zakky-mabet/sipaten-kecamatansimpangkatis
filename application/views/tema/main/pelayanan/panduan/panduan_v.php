	  			...
	  			<ul class="timeline">
				    ...
				    <li>
				        ...
				        <div class="timeline-item">
				            <h3 class="timeline-header"><a href="<?php echo site_url('epelayanan/read/'.$value->slug); ?>"><?php echo $value->judul; ?></a></h3>
				            <div class="timeline-body ">
				               <?php echo $value->deskripsi_singkat.'...'; ?>
				            </div>
				            <div class="timeline-footer ">
				                <a href="<?php echo site_url('epelayanan/read/'.$value->slug); ?>" class="btn btn-warning btn-xs">Selengkapnya..</a>
				            </div>
				        </div>
				    </li>
				    <?php } ?>
