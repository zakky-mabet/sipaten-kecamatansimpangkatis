 ...
 <div class="row">
  ...
  <div class="col-sm-12 form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea name="tempat_acara"  placeholder="Contoh : Jln. Raya Koba No. 141 RT. 05 Kel. Koba Kecamatan Koba Kabupaten Bangka Tengah" class="form-control"><?php echo set_value('tempat_acara');?></textarea>
