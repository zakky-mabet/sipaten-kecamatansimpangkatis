    ...
    <div class="col-md-12">
      ...
      <br>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea name="alamat_pindah"  placeholder="Alamat Pindah" class="form-control"><?php echo set_value('alamat_pindah');?></textarea>
        ...
        <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="klasifikasi_pindah" value="<?php echo set_value('klasifikasi_pindah');?>" class="form-control"  placeholder="Klasifikasi Pindah">
        ...
        <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="jns_kepindahan" value="<?php echo set_value('jns_kepindahan');?>" class="form-control"  placeholder="Jenis Kepindahan">
        ...
        <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="status_kk_tdk_pindah" value="<?php echo set_value('status_kk_tdk_pindah');?>" class="form-control"  placeholder="Status KK bagi yang tidak pindah">
        ...
        <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="status_kk_pindah" value="<?php echo set_value('status_kk_pindah');?>" class="form-control" placeholder="Status KK bagi yang pindah">
