 ...
 <div class="row">
              ...
              <div class="box-body ">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="tanggal_surat" id="datepicker1"  value="<?php echo set_value('tanggal_surat');?>" class="form-control"  placeholder="Ex : 1995-12-23">
  ...
  <div class="col-sm-12 form-horizontal">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="nama_perusahaan" id="need" onkeyup="myneed()"  class="form-control" value="<?php echo set_value('nama_perusahaan');?>"  placeholder="Nama Perusahaan">
           ...
           <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="desa_perusahaan" class="form-control" id="needdesa" onkeyup="myneeddesa()">
                      <option <?php echo set_select('desa_perusahaan', '',TRUE); ?> value="" >~~ pilih desa perusahaan ~~</option>
                      <?php foreach ($desa as $key => $value) { ?>
