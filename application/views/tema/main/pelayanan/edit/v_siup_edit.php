<div <?php echo ($this->agent->is_mobile()) ? 'class="container margin-container" style="padding-top:50px;"' : $browser ="style='padding-top:80px;' class='container'" ; ?>>
 ...
 <div class="row">
  ...
  <br>
      <p>
     Yang bertanda tangan di bawah ini Kepala Desa/Kelurahan : ... Kecamatan Simpangkatis Kab. Bangka Tengah, menerangkan dengan sebenarnya bahwa :
      </p>
  </div>
  <div class="col-sm-12 form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="no_hp" value="<?php echo $d_surat->no_hp ;?>" class="form-control" placeholder="">
  ...
  <div class="col-sm-12 form-horizontal ">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="nama_perusahaan" value="<?php echo $d_surat->nama_perusahaan ?>" class="form-control"  placeholder="Nama Perusahaan">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10"> 
              <textarea name="alamat_perusahaan"  placeholder="Contoh : Jln. Raya Simpangkatis No. 141 RT. 05 Kel. Simpangkatis Kecamatan Simpangkatis Kabupaten Bangka Tengah" class="form-control"><?php echo $d_surat->alamat_perusahaan ?></textarea>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="kedudukan" value="<?php echo $d_surat->kedudukan ;?>" class="form-control"  placeholder="Kedudukan dalam Perusahaan">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="bentuk_perusahaan" value="<?php echo $d_surat->bentuk_perusahaan ;?>" class="form-control"  placeholder="Bentuk Perusahaan ">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="bidang_usaha" value="<?php echo $d_surat->bidang_usaha ;?>" class="form-control"  placeholder="Bidang Usaha">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="kegiatan_usaha" value="<?php echo $d_surat->kegiatan_usaha ;?>" class="form-control"  placeholder="Kegiatan Usaha ">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="jenis_barang_a" value="<?php echo $d_surat->jenis_barang_a ;?>" class="form-control" placeholder="a.">
              <?php echo form_error('jenis_barang_a','<small class="text-red">','</small>'); ?>
            </div>
            <div class="col-md-10 col-md-offset-2">
              <input type="text" name="jenis_barang_b" value="<?php echo $d_surat->jenis_barang_b ;?>" class="form-control" placeholder="b.">
            </div>
            <br>
              <label  class="col-sm-2 control-label"></label>
            <div class="col-md-10 col-md-offset-2">
              <input type="text" name="jenis_barang_c" value="<?php echo $d_surat->jenis_barang_c ;?>" class="form-control" placeholder="c.">
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="number" name="modal_usaha" value="<?php echo $d_surat->modal_usaha ;?>" class="form-control"  placeholder="Modal Usaha">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
              <input type="number" name="jumlah_tenaga_laki" value="<?php echo $d_surat->jumlah_tenaga_laki ;?>" class="form-control" placeholder="Laki-laki">
              <span class="input-group-addon">Orang</span></div>
            </div>
            <div class="col-md-3">
            <div class="input-group">
              <input type="number" name="jumlah_tenaga_perempuan" value="<?php echo $d_surat->jumlah_tenaga_perempuan ;?>" class="form-control" placeholder="Wanita">
              <span class="input-group-addon">Orang</span></div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-5 text-center">
              ...
              <div class="input-group">
                <span class="input-group-addon">SD</span>
                  <input type="number" value="<?php echo $d_surat->pendidikan_laki_sd ;?>" class="form-control" name="pendidikan_laki_sd" >
                  <span class="input-group-addon">Orang</span>
              </div>
              <br>
              <div class="input-group">
                <span class="input-group-addon">SLTP</span>
                  <input type="number" class="form-control" value="<?php echo $d_surat->pendidikan_laki_sltp ;?>" name="pendidikan_laki_sltp">
                  <span class="input-group-addon">Orang</span>
              </div> 
              <br>
              <div class="input-group">
                <span class="input-group-addon">SLTA</span>
                  <input type="number" class="form-control" value="<?php echo $d_surat->pendidikan_laki_slta ;?>" name="pendidikan_laki_slta" >
                  <span class="input-group-addon">Orang</span>
              </div> 
              <br>
              <div class="input-group">
                <span class="input-group-addon">D3</span>
                  <input type="number" class="form-control" value="<?php echo $d_surat->pendidikan_laki_d3 ;?>" name="pendidikan_laki_d3" >
                  <span class="input-group-addon">Orang</span>
              </div> 
              <br>
              <div class="input-group">
                <span class="input-group-addon">S1</span>
                  <input type="number" class="form-control" value="<?php echo $d_surat->pendidikan_laki_s1 ;?>" name="pendidikan_laki_s1">
                  <span class="input-group-addon">Orang</span>
              </div> 
              <br>
              <div class="input-group">
                <span class="input-group-addon">S2</span>
                  <input type="number" class="form-control" value="<?php echo $d_surat->pendidikan_laki_s2 ;?>" name="pendidikan_laki_s2">
                  <span class="input-group-addon">Orang</span>
              </div>
              <br>
              <div class="input-group">
                <span class="input-group-addon">S3</span>
                  <input type="number" class="form-control" value="<?php echo $d_surat->pendidikan_laki_s3 ?>" name="pendidikan_laki_s3" >
                  <span class="input-group-addon">Orang</span>
              </div>
            </div>
            <div class="col-md-5 text-center">
              ...
              <div class="input-group">
                <span class="input-group-addon">SD</span>
                  <input type="number" class="form-control" value="<?php echo $d_surat->pendidikan_perempuan_sd ;?>" name="pendidikan_perempuan_sd">
                  <span class="input-group-addon">Orang</span>
              </div>
              <br>
              <div class="input-group">
                <span class="input-group-addon">SLTP</span>
                  <input type="number" class="form-control" value="<?php echo $d_surat->pendidikan_laki_sltp ;?>" name="pendidikan_perempuan_sltp">
                  <span class="input-group-addon">Orang</span>
              </div> 
              <br>
              <div class="input-group">
                <span class="input-group-addon">SLTA</span>
                  <input type="number" class="form-control" value="<?php echo $d_surat->pendidikan_perempuan_slta ?>" name="pendidikan_perempuan_slta">
                  <span class="input-group-addon">Orang</span>
              </div> 
              <br>
              <div class="input-group">
                <span class="input-group-addon">D3</span>
                  <input type="number" class="form-control" value="<?php echo $d_surat->pendidikan_perempuan_d3 ?>" name="pendidikan_perempuan_d3" >
                  <span class="input-group-addon">Orang</span>
              </div> 
              <br>
              <div class="input-group">
                <span class="input-group-addon">S1</span>
                  <input type="number" class="form-control" value="<?php echo $d_surat->pendidikan_perempuan_s1 ?>" name="pendidikan_perempuan_s1" >
                  <span class="input-group-addon">Orang</span>
              </div> 
              <br>
              <div class="input-group">
                <span class="input-group-addon">S2</span>
                  <input type="number" class="form-control" value="<?php echo $d_surat->pendidikan_perempuan_s2 ?>" name="pendidikan_perempuan_s2" >
                  <span class="input-group-addon">Orang</span>
              </div>
              <br>
              <div class="input-group">
                <span class="input-group-addon">S3</span>
                  <input type="number" class="form-control" value="<?php echo $d_surat->pendidikan_perempuan_s3 ;?>" name="pendidikan_perempuan_s3" >
                  <span class="input-group-addon">Orang</span>
              </div>
            </div>
          </div>
         ...
         <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="nama_pemilik_tanah" value="<?php echo $d_surat->nama_pemilik_tanah ?>" class="form-control"  placeholder="Nama Pemilik Tanah">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10"> 
              <textarea name="alamat_pemilik_tanah"  placeholder="Contoh : Jln. Raya Simpangkatis No. 141 RT. 05 Kel. Simpangkatis Kecamatan Simpangkatis Kabupaten Bangka Tengah" class="form-control"><?php echo $d_surat->alamat_pemilik_tanah ?></textarea>
          ...
          <div class="form-group">
            ...
            <div class="col-md-3">
              <div class="input-group">
                  <input type="number" class="form-control" name="jangka_waktu" value="<?php echo $d_surat->jangka_waktu ?>" placeholder="Jangka Waktu" >
          ...
          <div class="form-group">
            <div class="col-md-6 col-md-offset-2">
                    <div class="input-group registration-date-time">
                      <input class="form-control input-sm" value="<?php echo $d_surat->mulai_tanggal ?>"   name="mulai_tanggal"  id="datepicker1" placeholder="Mulai Tanggal ..">
                      <span class="input-group-addon"><span class="fa fa-calendar" aria-hidden="true"></span></span>
                      <input class="form-control input-sm" value="<?php echo $d_surat->sampai_tanggal ?>"  name="sampai_tanggal"  id="datepicker3" placeholder="Sampai Tanggal ..">
                    </div>  
              <p class="help-block"></p>
              <p class="help-block"></p>
            </div>
