 ...
 <div class="row">
  ...
  <div class="col-sm-12 form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
              <textarea class="form-control" placeholder="Contoh : Jln. Raya Simpangkatis No. 141 RT. 05 Kel. Simpangkatis Kecamatan Simpangkatis Kabupaten Bangka Tengah" name="alamat_perusahaan" rows="3"><?php echo $d_surat->alamat_perusahaan ;?></textarea>
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
              <textarea class="form-control" placeholder="Contoh : Jln. Raya Simpangkatis No. 141 RT. 05 Kel. Simpangkatis Kecamatan Simpangkatis Kabupaten Bangka Tengah" name="lokasi_bangunan" rows="3"><?php echo $d_surat->lokasi_bangunan ;?></textarea>
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
              <textarea name="alamat_pemilik_tanah" placeholder="Contoh : Jln. Raya Simpangkatis No. 141 RT. 05 Kel. Simpangkatis Kecamatan Simpangkatis Kabupaten Bangka Tengah" rows="3" class="form-control"><?php echo $d_surat->alamat_pemilik_tanah ?></textarea>
