      ...
      <form action="<?php current_url() ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
        ...
        redirect('epelayanan/histori','refresh');
          ...
          <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" name="nokk" value="<?php echo $d_surat->nokk ;?>" class="form-control"  placeholder="Nomor Kartu Keluarga ">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <?php if ($d_surat->status_perkawinan == 'Belum Kawin') { echo "checked";} else {  echo "";  } ?> <?php echo set_radio('status_perkawinan','Belum Kawin');?>  class="minimal form-control">&nbsp;&nbsp;  Belum Kawin&nbsp;&nbsp;
              
              <input type="radio" name="status_perkawinan" value="Kawin" 
              <?php if ($d_surat->status_perkawinan == 'Kawin') { echo "checked";} else {  echo "";  } ?> <?php echo set_radio('status_perkawinan','Kawin');?> class="minimal form-control">&nbsp;&nbsp;  Kawin&nbsp;&nbsp;

               <input type="radio" name="status_perkawinan" value="Cerai Hidup" 
               <?php if ($d_surat->status_perkawinan == 'Cerai Hidup') { echo "checked";} else {  echo "";  } ?> <?php echo set_radio('status_perkawinan','Cerai Hidup');?>  class="minimal form-control">&nbsp;&nbsp;  Cerai Hidup&nbsp;&nbsp;
                <input type="radio" name="status_perkawinan" value="Cerai Mati" 
                <?php if ($d_surat->status_perkawinan == 'Cerai Mati') { echo "checked";} else {  echo "";  } ?> <?php echo set_radio('status_perkawinan','Cerai Mati');?>  class="minimal form-control">&nbsp;&nbsp;  Cerai Mati&nbsp;&nbsp; <br>
           ...
           <div class="form-group">
            ...
            <div class="col-md-5">
            <input type="text" name="nomor_masuk" placeholder="Nomor Masuk" class="form-control" value="<?php echo $d_surat->nomor_masuk ?>">
            <?php echo form_error('nomor_masuk','<small class="text-red">','</small>'); ?>
          </div>
          <div class="col-md-5">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                <input type="text" class="form-control" name="tanggal_masuk" id="datepicker1" value="<?php echo $d_surat->tanggal_masuk ?>" placeholder="Ex : 04/20/1996">
              </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea name="alamat_asal"  placeholder="Contoh : Jln. Raya Simpangkatis No. 141 RT. 05 Kel. Simpangkatis Kecamatan Simpangkatis Kabupaten Bangka Tengah" class="form-control"><?php echo $d_surat->alamat_asal ?></textarea>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea name="alamat_pindah"  placeholder="Contoh : Jln. Raya Simpangkatis No. 141 RT. 05 Kel. Simpangkatis Kecamatan Simpangkatis Kabupaten Bangka Tengah" class="form-control"><?php echo $d_surat->alamat_pindah ?></textarea>
        ...
        <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" name="kode_pos" value="<?php echo $d_surat->kode_pos ?>" class="form-control"  placeholder="Kode Pos">
            ...
            <div class="col-md-10">
              <div class="col-md-4">
                    <div class="radio radio-primary">
                       <input name="alasan_pindah" class="minimal form-control" type="radio" value="pekerjaan" 
                       <?php if ($d_surat->alasan_pindah == 'pekerjaan') { echo "checked";} else {  echo "";  } ?> <?php echo set_radio('alasan_pindah','pekerjaan');?> > <label> Pekerjaan</label>
                    </div>
                    <div class="radio radio-primary">
                       <input name="alasan_pindah" class="minimal form-control" type="radio" value="pendidikan" 
                       <?php if ($d_surat->alasan_pindah == 'pendidikan') { echo "checked";} else {  echo "";  } ?> <?php echo set_radio('alasan_pindah','pendidikan');?>> <label> Pendidikan</label>
                    </div>
              </div>
              <div class="col-md-4">
                    <div class="radio radio-primary">
                       <input name="alasan_pindah" class="minimal form-control" type="radio" value="keamanan" 
                       <?php if ($d_surat->alasan_pindah == 'pekerjaan') { echo "keamanan";} else {  echo "";  } ?> <?php echo set_radio('alasan_pindah','keamanan');?>> <label> Keamanan</label>
                    </div>
                    <div class="radio radio-primary">
                       <input name="alasan_pindah" class="minimal form-control" type="radio" value="kesehatan" 
                       <?php if ($d_surat->alasan_pindah == 'kesehatan') { echo "checked";} else {  echo "";  } ?> <?php echo set_radio('alasan_pindah','kesehatan');?>> <label> Kesehatan</label>
                    </div>
              </div>
              <div class="col-md-4">
                    <div class="radio radio-primary">
                       <input name="alasan_pindah" class="minimal form-control" type="radio" value="keluarga" 
                       <?php if ($d_surat->alasan_pindah == 'keluarga') { echo "checked";} else {  echo "";  } ?> <?php echo set_radio('alasan_pindah','keluarga');?>> <label> Keluarga</label>
                    </div>
                    <div class="radio radio-primary">
                       <input name="alasan_pindah" type="radio"  class="minimal form-control" value="Lainnya" 
                       <?php if ($d_surat->alasan_pindah == 'Lainnya') { echo "checked";} else {  echo "";  } ?><?php echo set_radio('alasan_pindah','lainnya');?>> <label> Lainnya</label>
                    </div>
              </div>
         ...
         <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="darah" class="form-control">
                      <option <?php echo set_select('darah', $d_surat->darah,TRUE); ?> value="<?php echo $d_surat->darah ; ?>"><?php echo $d_surat->darah ; ?></option>
        ...
        <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" name="nik_penanggung" value="<?php echo $d_surat->nik_penanggung ?>" class="form-control"  placeholder="NIK">
        ...
        <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="nama_penanggung" value="<?php echo $d_surat->nama_penanggung ?>" class="form-control"  placeholder="Nama Lengkap">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea name="alamat_penanggung"  placeholder="Contoh : Jln. Raya Simpangkatis No. 141 RT. 05 Kel. Simpangkatis Kecamatan Simpangkatis Kabupaten Bangka Tengah" class="form-control"><?php echo $d_surat->alamat_penanggung ;?></textarea>
        ...
        <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="pekerjaan_penanggung" value="<?php echo $d_surat->pekerjaan_penanggung ?>" class="form-control"  placeholder="Pekerjaan">
