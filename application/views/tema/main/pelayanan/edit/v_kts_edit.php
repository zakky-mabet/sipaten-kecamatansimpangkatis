      ...
      <form action="<?php current_url() ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
        ...
        redirect('epelayanan/histori','refresh');
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea name="alamat_asal"  placeholder="Contoh : Jln. Raya Koba No. 141 RT. 05 Kel. Koba Kecamatan Koba Kabupaten Bangka Tengah" class="form-control"><?php echo $d_surat->alamat_asal ?></textarea>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea name="alamat_pindah"  placeholder="Contoh : Jln. Raya Koba No. 141 RT. 05 Kel. Koba Kecamatan Koba Kabupaten Bangka Tengah" class="form-control"><?php echo $d_surat->alamat_pindah ?></textarea>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea name="alamat_penanggung"  placeholder="Contoh : Jln. Raya Koba No. 141 RT. 05 Kel. Koba Kecamatan Koba Kabupaten Bangka Tengah" class="form-control"><?php echo $d_surat->alamat_penanggung ;?></textarea>
