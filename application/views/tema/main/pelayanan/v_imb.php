<div <?php echo ($this->agent->is_mobile()) ? 'class="container margin-container" style="padding-top:50px;"' : $browser ="style='padding-top:80px;' class='container'" ; ?>>
 ...
 <div class="row">
  ...
  <div class="box-body">
    <div class="col-md-12">
      <div class="row">
            ...
            <br>
      <form action="<?php base_url('epelayanan/imb') ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
            ...
            <div class="form-horizontal">
              <div class="box-body ">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="nik" name="nik" value="<?php echo set_value('nik');?>" class="form-control"  placeholder="NIK Pemohon">
  ...
  <br>
      <p>
     Yang bertanda tangan di bawah ini Kepala Desa/Kelurahan : ... Simpangkatis Kab. Bangka Tengah, menerangkan dengan sebenarnya bahwa :
  ...
  <div class="col-sm-12 form-horizontal">
          ...
          <div class="col-md-4">
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="tgl_lahir" id="datepicker" value="<?php echo set_value('tgl_lahir');?>" placeholder="Ex : 1985-12-23">
              </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea name="alamat"  placeholder="Contoh : Jln. Raya Simpangkatis No. 141 RT. 05 Kel. Simpangkatis Kecamatan Simpangkatis Kabupaten Bangka Tengah" class="form-control"><?php echo set_value('alamat');?></textarea>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="number" name="no_hp" value="<?php echo set_value('no_hp');?>" class="form-control" placeholder="No Telepon/HP">
  ...
  <div class="col-sm-12 form-horizontal">
          <div class="form-group">
            ...
            <div class="col-md-10">
              <input type="text" name="nama_perusahaan" class="form-control" placeholder="Nama Perusahaan" value="<?php echo set_value('nama_perusahaan');?>">
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
              <textarea class="form-control" placeholder="Contoh : Jln. Raya Simpangkatis No. 141 RT. 05 Kel. Simpangkatis Kecamatan Simpangkatis Kabupaten Bangka Tengah" name="alamat_perusahaan" rows="3"><?php echo set_value('alamat_perusahaan');?></textarea>
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
              <input type="text" name="jenis_bangunan" placeholder="Jenis Bangunan" class="form-control" value="<?php echo set_value('jenis_bangunan');?>">
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
              <textarea class="form-control" placeholder="Contoh : Jln. Raya Simpangkatis No. 141 RT. 05 Kel. Simpangkatis Kecamatan Simpangkatis Kabupaten Bangka Tengah" name="lokasi_bangunan" rows="3"><?php echo set_value('lokasi_bangunan');?></textarea>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6">
              <div class="input-group">
                  <input type="number" class="form-control"  name="lt_1_1" value="<?php echo set_value('lt_1_1');?>">
                  <span class="input-group-addon">X</span>
                  <input type="number" class="form-control"  name="lt_1_2" value="<?php echo set_value('lt_1_2');?>">
                  <span class="input-group-addon">=</span>
                  <input type="number" class="form-control"  name="total_1" value="<?php echo set_value('total_1');?>">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6">
              <div class="input-group">
                  <input type="number" class="form-control" name="lt_2_1" value="<?php echo set_value('lt_2_1');?>">
                  <span class="input-group-addon">X</span>
                  <input type="number" class="form-control" name="lt_2_2" value="<?php echo set_value('lt_2_1');?>">
                  <span class="input-group-addon">=</span>
                <input type="number" class="form-control" name="total_2" value="<?php echo set_value('total_2');?>">
                <strong class="input-group-addon">M<sup>2</sup></strong>
              </div>
           </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6">
              <div class="input-group">
                  <input type="number" class="form-control" name="lt_3_1" value="<?php echo set_value('lt_3_1');?>">
                  <span class="input-group-addon">X</span>
                  <input type="number" class="form-control" name="lt_3_2" value="<?php echo set_value('lt_3_1');?>">
                  <span class="input-group-addon">=</span>
                <input type="number" class="form-control" name="total_3" value="<?php echo set_value('total_3');?>">
                <strong class="input-group-addon">M<sup>2</sup></strong>
              </div>
           </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
              <input type="text" name="gsb" placeholder="Garis Sempadan Bangunan" class="form-control" value="<?php echo set_value('gsb');?>"> 
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
              <input type="text" name="nama_pemilik_tanah" placeholder="Nama Pemilik Tanah " class="form-control" value="<?php echo set_value('nama_pemilik_tanah');?>">
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
              <textarea name="alamat_pemilik_tanah" placeholder="Contoh : Jln. Raya Simpangkatis No. 141 RT. 05 Kel. Simpangkatis Kecamatan Simpangkatis Kabupaten Bangka Tengah" rows="3" class="form-control"><?php echo set_value('alamat_pemilik_tanah');?></textarea>
          ...
          <div class="form-group">
            ...
            <div class="col-md-3">
              <div class="input-group">
                  <input type="number" class="form-control" placeholder="Jangka Waktu" name="jangka_waktu" value="<?php echo set_value('jangka_waktu');?>">
          ...
          <div class="form-group">
            <div class="col-md-6 col-md-offset-2">
                    <div class="input-group registration-date-time">
                      <input class="form-control input-sm" name="mulai_tanggal" value="<?php echo set_value('mulai_tanggal');?>" id="datepicker1" placeholder="Mulai Tanggal ..">
                      <span class="input-group-addon"><span class="fa fa-calendar" aria-hidden="true"></span></span>
                      <input class="form-control input-sm" name="sampai_tanggal" value="<?php echo set_value('sampai_tanggal');?>" id="datepicker3" placeholder="Sampai Tanggal ..">
                    </div>  
