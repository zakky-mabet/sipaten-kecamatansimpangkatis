<div <?php echo ($this->agent->is_mobile()) ? 'class="container margin-container" style="padding-top:50px;"' : $browser ="style='padding-top:80px;' class='container'" ; ?>>
 ...
 <div class="row">
  ...
  <br>
      <p>
      Yang bertanda tangan dibawah ini Lurah ... Kecamatan Simpangkatis Kabupaten Bangka Tengah dengan ini menerangkan :
      </p>
      <p>
  ...
  <br>
    ...
    untuk melengkapi pemberkasan penerimaan <span class="text-green" id="needed"></span>
