 ...
 <div class="row">
  ...
  <div class="box-body">
    <div class="col-md-12">
      <div class="row">
            ...
            <br>
      <form action="<?php echo site_url('epelayanan/sp3fat') ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
  ...
  <div class="col-sm-12 form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
            <input type="text" name="no_surat_kuasa" placeholder="Nomor Surat"  class="form-control" value="<?php echo set_value('no_surat_kuasa');?>">
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
            <input type="text" name="tgl_surat_kuasa" placeholder="Ex : 1985-12-23 " id="datepicker" class="form-control" value="<?php echo set_value('tgl_surat_kuasa');?>">
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
            <input type="text" name="tgl_diketahui" placeholder="Ex : 1985-12-23 " id="datepicker1" class="form-control" value="<?php echo set_value('tgl_diketahui');?>">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea name="letak_tanah"  placeholder="Contoh : Jln. Raya Simpangkatis No. 141 RT. 05 Kel. Simpangkatis Kecamatan Simpangkatis Kabupaten Bangka Tengah" class="form-control"><?php echo set_value('letak_tanah');?></textarea>
            ...
            <div class="col-md-5">
              <div class="input-group">
                <span class="input-group-addon">&plusmn;</span>
                  <input type="text"  class="form-control" name="luas_tanah" placeholder="Luas Tanah" value="<?php echo set_value('luas_tanah');?>">
          ...
          <div class="form-group">
            ...
            <div class="col-md-5">
              <input type="text" class="form-control" placeholder="Keterangan" name="batas_utara_ket" value="<?php echo set_value('batas_utara_ket');?>">
              <?php echo form_error('batas_utara_ket','<small class="text-red">','</small>'); ?>
            </div>
            <div class="col-md-5">
              <div class="input-group">
                  <input type="text" class="form-control" placeholder="Terbilang, Ex : 90 " name="batas_utara_val" value="<?php echo set_value('batas_utara_val');?>">
          ...
          <div class="form-group">
            ...
            <div class="col-md-5">
              <input type="text" class="form-control" placeholder="Keterangan" name="batas_timur_ket" value="<?php echo set_value('batas_timur_ket');?>">
              <?php echo form_error('batas_timur_ket','<small class="text-red">','</small>'); ?>
            </div>
            <div class="col-md-5">
              <div class="input-group">
                  <input type="text" class="form-control" placeholder="Terbilang, Ex : 90 " name="batas_timur_val" value="<?php echo set_value('batas_timur_val');?>">
                  <span class="input-group-addon">&plusmn; M<sup>2</sup> </span>
              </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-5">
              <input type="text" class="form-control" placeholder="Keterangan" name="batas_selatan_ket" value="<?php echo set_value('batas_selatan_ket');?>">
              <?php echo form_error('batas_selatan_ket','<small class="text-red">','</small>'); ?>
            </div>
            <div class="col-md-5">
              <div class="input-group">
                  <input type="text" class="form-control" placeholder="Terbilang, Ex : 90 " name="batas_selatan_val" value="<?php echo set_value('batas_selatan_val');?>">
                  <span class="input-group-addon">&plusmn; M<sup>2</sup> </span>
              </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-5">
              <input type="text" class="form-control" placeholder="Keterangan" name="batas_barat_ket" value="<?php echo set_value('batas_barat_ket');?>">
              <?php echo form_error('batas_barat_ket','<small class="text-red">','</small>'); ?>
            </div>
            <div class="col-md-5">
              <div class="input-group">
                  <input type="text" class="form-control" placeholder="Terbilang, Ex : 90 " name="batas_barat_val" value="<?php echo set_value('batas_barat_val');?>">
                  <span class="input-group-addon">&plusmn; M<sup>2</sup> </span>
              </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-3">
              <div class="input-group">
                  <input type="text" class="form-control" placeholder="Tahun" name="tahun_kuasa" value="<?php echo set_value('tahun_kuasa');?>">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="number" name="nik" class="form-control" value="<?php echo set_value('nik');?>"  placeholder="Nomor Induk Kependudukan">
          ...
          <div class="col-md-5">
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="tgl_lahir" id="datepicker2" value="<?php echo set_value('tgl_lahir');?>" placeholder="Ex : 1985-12-23">
              </div>
      ...
      <h4 class="text-green">Persyaratan Pembuatan <?php echo $crumb ?> :</h4>
        ...
        <tbody >
          <tr>
            ...
            <td>
              <input name="sp3fat_1" type="file" class="form-control" />
            </td>
          </tr>
          <tr>
            ...
            <td>
              <input type="file" name="sp3fat_2" class= "form-control" />
            </td>
          </tr>
