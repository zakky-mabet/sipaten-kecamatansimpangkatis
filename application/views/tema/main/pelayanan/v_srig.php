 ...
 <div class="row">
  ...
  <div class="box-body">
    <div class="col-md-12">
      <div class="row">
            ...
            <br>
      <form action="<?php base_url('epelayanan/srig') ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
  ...
  <div class="col-sm-12 form-horizontal" >
    <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="nama_toko" class="form-control" value="<?php echo set_value('nama_toko');?>" placeholder="Nama Toko/Kios/Perusahaan">
      ...
      <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="jenis_kegiatan" class="form-control" value="<?php echo set_value('jenis_kegiatan');?>" placeholder="Jenis Kegiatan">
      ...
      <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="jenis_bangunan" class="form-control" value="<?php echo set_value('jenis_bangunan');?>" placeholder="Jenis Bangunan">
  ...
  <div class="col-sm-12 form-horizontal" >
    <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="no_surat" class="form-control" value="<?php echo set_value('no_surat');?>" placeholder="Nomor Surat">
    ...
    <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="tgl_surat" class="form-control" value="<?php echo set_value('tgl_surat');?>" id="datepicker2"  placeholder="Ex : 1995-12-23">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="nama_lurah" class="form-control" value="<?php echo set_value('nama_lurah');?>" placeholder="Nama Lurah/Kades">
      ...
      <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="jabatan_lurah" class="form-control" value="<?php echo set_value('jabatan_lurah');?>" placeholder="Jabatan Lurah/Kades">
