 ...
 <div class="row">
  ...
  <div class="box-body">
    <div class="col-md-12">
      <div class="row">
            ...
            <br>
      <form action="<?php base_url('epelayanan/skw') ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
  ...
  <div class="col-sm-12 form-horizontal">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="number" name="nik" class="form-control" value="<?php echo set_value('nik');?>"  placeholder="NIK Pemohon">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="nama_kades" class="form-control" value="<?php echo set_value('nama_kades');?>"  placeholder="Ex : Surtama, S.E., M.M.">
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
            <input type="number" name="nip" placeholder="NIP" class="form-control" value="<?php echo set_value('nip');?>">
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
            <input type="text" name="pangkat" placeholder="Ex : Penata Tk. / IIId" class="form-control" value="<?php echo set_value('pangkat');?>">
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
            <input type="text" name="jabatan" placeholder="Ex :  Lurah Simpang Perlang" class="form-control" value="<?php echo set_value('jabatan');?>">
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
            <input type="text" name="tanggal" placeholder="Ex : 1995-12-23" id="datepicker" class="form-control" value="<?php echo set_value('tanggal');?>">
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
            <input type="text" name="diketahui" placeholder="Ex : Ketua RT. 015 Kelurahan Simpang Perlang"  class="form-control" value="<?php echo set_value('diketahui');?>">
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
            <input type="text" name="tanggal_diketahui" placeholder="Ex : 1995-12-23 " id="datepicker1" class="form-control" value="<?php echo set_value('tanggal_diketahui');?>">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <div class="col-md-10">
            <input type="text" name="nomor_akta" placeholder="Ex : 1904­KM­22112016 " class="form-control" value="<?php echo set_value('nomor_akta');?>">
           ...
           <div class="form-group">
            ...
            <div class="col-md-10">
            <input type="text" name="ditandatangani" placeholder="Ex : Kepala Dinas Kependudukan dan Pencatatan Sipil" class="form-control" value="<?php echo set_value('ditandatangani');?>">
          ...
          <div class="form-group">
            <label  class="col-sm-2 control-label font-title">Tanggal  <span class="text-red">*</span></label>
            <div class="col-md-10">
            <input type="text" name="tanggal_kematian" placeholder="Ex : 1995-12-23" id="datepicker3" class="form-control" value="<?php echo set_value('tanggal_kematian');?>">
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
            <input type="text" name="nama_kematian" placeholder="Nama" class="form-control" value="<?php echo set_value('nama_kematian');?>">
          ...
          <div class="form-group">
            ...
            <div class="col-md-3">
              <div class="input-group">
                  <input type="number" class="form-control" placeholder="Umur" name="umur" value="<?php echo set_value('umur');?>">
          ...
          <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="hari" class="form-control">
                      <option <?php echo set_select('hari', '',TRUE); ?> value="">~~ pilih hari kematian ~~</option>
           ...
           <div class="form-group">
            <label  class="col-sm-2 control-label font-title">Tanggal  <span class="text-red">*</span></label>
            <div class="col-md-10">
            <input type="text" name="tanggal_keterangan_kematian" placeholder="Ex : 1995-12-23 " id="datepicker2" class="form-control" value="<?php echo set_value('tanggal_keterangan_kematian');?>">
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
            <input type="text" name="ditempat" placeholder="Ex : RUMAH SAKIT UMUM DAERAH BANGKA TENGAH" id="datepicker2" class="form-control" value="<?php echo set_value('ditempat');?>">
