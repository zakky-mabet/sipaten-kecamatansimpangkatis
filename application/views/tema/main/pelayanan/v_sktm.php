 ...
 <div class="row">
  ...
  <div class="col-sm-12 form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="tgl_lahir" class="form-control" value="<?php echo set_value('tgl_lahir');?>" id="datepicker"  placeholder="Ex : 1985-12-23">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="no_surat_rek" class="form-control" value="<?php echo set_value('no_surat_rek');?>" placeholder="Nomor Surat">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="tgl_surat_rek" id="datepicker1" class="form-control" value="<?php echo set_value('tgl_surat_rek');?>" placeholder="Tanggal Surat">
  ...
  <br>
      <p>
      Nama tersebut adalah warga Kecamatan Simpangkatis Kabupaten Bangka, dan menurut Keluarga Tidak Mampu/Keluarga Pra Sejahtera. Dan Surat Keterangan ini dipergunakan untuk <span class="text-green" id="needed"></span>
      </p>
      <p>
