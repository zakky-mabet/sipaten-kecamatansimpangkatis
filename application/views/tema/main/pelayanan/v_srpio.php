<div <?php echo ($this->agent->is_mobile()) ? 'class="container margin-container" style="padding-top:50px;"' : $browser ="style='padding-top:80px;' class='container'" ; ?>>
 ...
 <div class="row">
  ...
  <br>
      <p>
     Berdasarkan Surat dari Pengelola <span class="text-orange kapital" id="needed"></span>.  perihal Pemohonan Rekomendasi Perpanjangan Izin Oprasional a.n
      </p>
  </div>
  <div class="col-sm-12 form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="nama_lembaga" id="need" onkeyup="myneed()"  class="form-control" value="<?php echo set_value('nama_lembaga');?>"  placeholder="Nama Lembaga">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="nama_pengelola" class="form-control" value="<?php echo set_value('nama_pengelola');?>"  placeholder="Nama Pengelola">
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
            <input type="text" name="nomor_surat" placeholder="Nomor Surat " class="form-control" value="<?php echo set_value('nomor_surat');?>">
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
            <input type="text" name="tanggal_surat" placeholder="Ex : 1985-12-23 " id="datepicker3" class="form-control" value="<?php echo set_value('tanggal_surat');?>">
  ...
  <br>
      <p>
    Dengan maksud mengajukan Permohonan Perpanjangan Izin Oprasional. Dan Pihak kami prinsipnya tidak keberatan untuk memberikan rekomendasi Perpanjangan Izin Oprasional  <span class="text-orange kapital" id="needed"></span> sepanjang mematuhi dan mentaati segala peraturan dan perundang­undangan yang berlaku
      </p>
      <p>
