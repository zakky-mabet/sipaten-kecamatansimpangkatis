 ...
 <div class="row">
  ...
  <div class="box-body">
    <div class="col-md-12">
      <div class="row">
            ...
            <br>
      <form action="<?php base_url('epelayanan/srku') ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
  ...
  <div class="col-sm-12 form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="pejabat_lurah" class="form-control" value="<?php echo set_value('pejabat_lurah');?>" placeholder="Nama Pejabat Lurah / Kades">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="nip_pejabat_lurah" class="form-control" value="<?php echo set_value('nip_pejabat_lurah');?>" placeholder="NIP">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="jabatan_pejabat_lurah" class="form-control" value="<?php echo set_value('jabatan_pejabat_lurah');?>" placeholder="Jabatan">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea name="alamat_usaha" id="needalamat" onkeyup="myneedalamat()"  placeholder="Contoh : Jln. Raya Simpangkatis No. 141 RT. 05 Kel. Simpangkatis Kecamatan Simpangkatis Kabupaten Bangka Tengah" class="form-control"><?php echo set_value('alamat_usaha');?></textarea>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="usaha" value="<?php echo set_value('usaha');?>" class="form-control" id="need" onkeyup="myneed()" placeholder="Contoh : Pencucian Motor">
  ...
  <br>
      <p>
     Nama tersebut diatas memang benar mempunyai usaha "<span class="text-green" id="needed"></span>" yang beralamat di 
    "<span class="text-green" id="neededalamat"></span>"
      </p>
      <p>
      ...
      <h4 class="text-green">Persyaratan <?php echo $crumb; ?> :</h4>
        ...
        <tbody >
          <tr>
            ...
            <td>
              <input  type="file" name="srku_1" class="form-control" />
            </td>
          </tr>
          <tr>
            ...
            <td>
              <input type="file" name="srku_2" class= "form-control" />
            </td>
          </tr>
          <tr>
            ...
            <td class="text-center">
              <input type="file" name="srku_3" class="form-control" />
            </td>
          </tr>
           <tr>
            <td colspan="3">
