		...
		<div style=" margin-left: auto; margin-right: auto; width: 100%; padding: 10px;">
			<header  style="width: auto; ">
				...
				<div style=" width: auto; background-color: #FAFAFA; box-shadow: 1px 1px 1px; border-radius: 0px 0px 2px 2px ">
					...
					<br>
					<p style="margin: 0;  padding-left: 40px;font-size: 1em;  ">
						Anda menerima pesan ini karena alamat email ini digunakan untuk mendaftar akun ke Sistem Informasi Pelayanan Kecamatan Koba, Jika ini benar email anda silahkan klik <a href="<?php echo base_url('daftar/verifikasi'); ?>" title="verifikasi" target="_blank">disini</a> untuk memverifikasi email anda.
					</p>
					<br>
