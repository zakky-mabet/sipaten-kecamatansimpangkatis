...
<html>
<head>
  <title>Verifikasi email - Sistem Informasi Pelayanan Online Kecamatan Simpang Katis</title>
</head>
<body style="margin: 0; font-family: arial">
		<div style=" margin-left: auto; margin-right: auto; width: 100%; padding: 10px;">
			<header  style="width: auto; ">
				<div style=" float: left; margin-right:10px;">
					<img width="60" src="https://upload.wikimedia.org/wikipedia/commons/1/1b/Lambang_Kabupaten_Bangka_Tengah.png" alt="logo Simpang Katis - bangka tengah">
				</div>
				<div style="float: left">
					<h1 style="margin: 0; padding-top: 12px; color:#4184F3 ">PAKISS</h1>
					<p style="margin: 0; font-size: 1.2em;">Simpang Katis Informations And Services </p>
				</div>
				<div style="clear: both"></div>	
				<div style="margin-top: 5px; width: auto;  height: 100px; background-color: #14A951; box-shadow: 1px 1px 1px; border-radius: 2px 2px 0px 0px ">
				...
				<div style=" width: auto; background-color: #FAFAFA; box-shadow: 1px 1px 1px; border-radius: 0px 0px 2px 2px ">
					...
					<p style="margin: 0; padding-top: 20px;  padding-left: 40px;font-size: 1em;  ">
						Kami menerima permintaan pendaftaran Akun Sistem Informasi Pelayanan Kecamatan Simpang Katis melalui alamat email Anda (<?php echo $email_anda; ?>). Kode verifikasi akun Anda adalah :
					</p>
					...
					<br>
					<p style="margin: 0;  padding-left: 40px;font-size: 1em;  ">
						Anda menerima pesan ini karena alamat email ini digunakan untuk mendaftar akun ke Sistem Informasi Pelayanan Kecamatan Simpang Katis, Jika ini benar email anda silahkan klik <a href="<?php echo base_url('daftar/verifikasi'); ?>" title="verifikasi" target="_blank">disini</a> untuk memverifikasi email anda.
					</p>
					<br>
					...
					<p style="margin: 0; padding-top: 20px; padding-bottom: 44px;  padding-left: 40px;font-size: 0.8em;  ">
						...
						<br>&copy; Kecamatan Simpang Katis
					</p>
			</header><!-- /header -->
