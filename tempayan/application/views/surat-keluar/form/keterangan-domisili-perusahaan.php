...
?>
			<div class="box-body" style="margin-top: 10px;">
				<div class="col-md-7">
					...
					?>
								<option value="<?php echo $row->nama_desa; ?>" <?php if($row->id_desa==$isi->desa) echo 'selected'; ?>><?php echo $row->nama_desa; ?></option>
					<?php  
					endforeach;
					?>
							</select>
					...
					?>
								<option value="<?php echo $row->ID; ?>" <?php if($row->ID==$get->pemeriksa) echo 'selected'; ?>><?php echo $row->name; ?></option>
					<?php  
					endforeach;
					?>
							</select>
