...
?>
    <div class="content">
        <div class="mail-heading">
            <h5 class="mail-name upper" style="font-size: 12px;"><?php echo $get->judul_surat; ?> </h5> <br>
...
/* End of file sp4fat.php */
/* Location: ./application/views/surat-keluar/print/sp4fat.php */