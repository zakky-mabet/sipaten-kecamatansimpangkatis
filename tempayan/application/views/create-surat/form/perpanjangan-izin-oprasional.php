			...
			<div class="box-body" style="margin-top: 10px;">
				<div class="col-md-7">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="text" name="isi[nama_lembaga]" class="form-control" value="<?php echo set_value('isi[nama_lembaga]'); ?>">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="text" name="isi[nama_pengelola]" class="form-control" value="<?php echo set_value('isi[nama_pengelola]'); ?>">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<textarea name="isi[alamat_lembaga]" class="form-control" cols="30" rows="3"><?php echo set_value('isi[alamat_lembaga]'); ?></textarea>
