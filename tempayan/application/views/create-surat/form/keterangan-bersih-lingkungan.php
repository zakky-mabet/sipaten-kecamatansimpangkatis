			...
			<div class="box-body" style="margin-top: 10px;">
				<div class="col-md-7">
					...
					<div class="form-group">
						...
						<label for="email" class="control-label col-md-3 col-xs-12">Nomor Surat : <strong class="text-red">*</strong></label>
						<div class="col-md-9">
							<input type="text" name="isi[no_surat_ket]" class="form-control" value="<?php echo set_value('isi[no_surat_ket]'); ?>">
					...
					<div class="form-group">
						...
						<div class="col-md-7">
							<input type="text" class="form-control" name="isi[tgl_surat_ket]" id="datepicker" value="<?php echo set_value('isi[tgl_surat_ket]'); ?>" placeholder="Ex : <?php echo date('Y-m-d'); ?>">
