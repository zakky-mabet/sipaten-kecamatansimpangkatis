 ...
 * @var string
 **/
echo form_open_multipart(site_url('employee/set_upload'), array('class' => 'form-horizontal'))	
?>
					...
					<div class="col-md-12">
			           <div class="callout callout-default">
			               ...
			               <p>- Field - field yang diunggah harus sesuai dengan contoh yang ada. 
							<a href="<?php echo base_url("public/files/CONTOH-IMPOR-PEGAWAI.xlsx") ?>" target="_blank" class="text-blue">Lihat Disini</a>
			               </p>
			           </div>
					</div>
				</div>
