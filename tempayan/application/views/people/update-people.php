			...
			<div class="box-body" style="margin-top: 10px;">
				...
				<div class="form-group">
					...
					<div class="col-md-6">
				           ...
				           <input name="status_kk" type="radio" value="kepala keluarga" <?php if($people->status_kk=='kepala keluarga') echo "checked"; ?>> <label for="status_kk"> Kepala Keluarga</label>
				       	</div>
				       	<div class="radio radio-inline radio-primary">
				           <input name="status_kk" type="radio" value="istri" <?php if($people->status_kk=='istri') echo "checked"; ?>> <label for="status_kk"> Istri</label>
				       	</div>
				       	<div class="radio radio-inline radio-primary">
				           <input name="status_kk" type="radio" value="anak" <?php if($people->status_kk=='anak') echo "checked"; ?>> <label for="status_kk"> Anak</label>
				       	</div>
				       	<div class="radio radio-inline radio-primary">
				           <input name="status_kk" type="radio" value="ayah" <?php if($people->status_kk=='ayah') echo "checked"; ?>> <label for="status_kk"> Ayah</label>
				       	</div>
				       	<div class="radio radio-inline radio-primary">
				           <input name="status_kk" type="radio" value="ibu" <?php if($people->status_kk=='ibu') echo "checked"; ?>> <label for="status_kk"> Ibu</label>
				       	</div>
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<input type="text" name="tmp_lahir" class="form-control" value="<?php echo $people->tmp_lahir; ?>">
						<p class="help-block"><?php echo form_error('tmp_lahir', '<small class="text-red">', '</small>'); ?></p>
					</div>
					<div class="col-md-4">
					  	<div class="input-group">
					    	<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
					    	<input type="text" class="form-control" name="birts" id="datepicker" value="<?php echo $people->tgl_lahir; ?>" placeholder="Ex : 1980-12-31">
					  	</div>
				...
				<div class="form-group">
					...
					<div class="col-md-6">
				       	<div class="radio radio-inline radio-primary">
				           <input name="gender" type="radio" value="LAKI-LAKI" <?php if($people->jns_kelamin=='LAKI-LAKI') echo "checked"; ?>> <label for="gender"> Laki-laki</label>
				       	</div>
				       	<div class="radio radio-inline radio-primary">
				           <input name="gender" type="radio" value="PEREMPUAM" <?php if($people->jns_kelamin=='PEREMPUAM') echo "checked"; ?>> <label for="gender"> Perempuan</label>
				       	</div>
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<select name="agama" class="form-control">
							...
							<option value="islam" <?php if($people->agama=='islam') echo "selected"; ?>>Islam</option>
							<option value="kristen" <?php if($people->agama=='kristen') echo "selected"; ?>>Kristen</option>
							<option value="katholik" <?php if($people->agama=='katholik') echo "selected"; ?>>Katholik</option>
				...
				<div class="form-group">
					...
					<div class="col-md-6">
				       	<div class="radio radio-inline radio-primary">
				           <input name="status_kawin" type="radio" value="belum kawin" <?php if($people->status_kawin=='belum kawin') echo "checked"; ?>> <label> Belum Kawin</label>
				       	</div>
				       	<div class="radio radio-inline radio-primary">
				...
				<div class="form-group">
					...
					<div class="col-md-6">
				           ...
				           <input name="kewarganegaraan" type="radio" value="wni" <?php if($people->kewarganegaraan=='wni') echo "checked"; ?>> <label for="kewarganegaraan"> WNI (Warga Negara Indonesia)</label>
				       	</div>
				       	<div class="radio radio-primary">
				           <input name="kewarganegaraan" type="radio" value="wna" <?php if($people->kewarganegaraan=='wna') echo "checked"; ?>> <label for="kewarganegaraan"> WNA (Warga Negara Asing)</label>
				       	</div>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="pekerjaan" class="form-control" value="<?php echo $people->pekerjaan; ?>">
				...
				<div class="form-group">
					...
					<div class="col-md-3">
						<select name="gol_darah" class="form-control">
							<option value="">-- PILIH --</option>
							<option value="A" <?php if($people->gol_darah=='A') echo "selected"; ?>>A</option>
							<option value="B" <?php if($people->gol_darah=='B') echo "selected"; ?>>B</option>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<textarea name="alamat" rows="3" class="form-control"><?php echo $people->alamat; ?></textarea>
				...
				<div class="form-group">
					...
					<div class="col-md-2">
						<input type="text" name="rt" class="form-control" value="<?php echo $people->rt; ?>">
						<p class="help-block"><?php echo form_error('rt', '<small class="text-red">', '</small>'); ?></p>
					</div>
					<div class="col-md-2">
						<input type="text" name="rw" class="form-control" value="<?php echo $people->rw; ?>">
				...
				<div class="form-group">
					...
					foreach($desa as $row) :
					?>
							<option value="<?php echo $row->id_desa; ?>" <?php if($people->desa==$row->id_desa) echo "selected"; ?>><?php echo $row->nama_desa; ?></option>
					<?php  
					endforeach;
					?>
						</select>
