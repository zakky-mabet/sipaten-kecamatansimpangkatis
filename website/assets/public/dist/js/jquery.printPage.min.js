(function($){$.fn.printPage=function(options){var pluginOptions={attr:"href",url:!1,message:"Tunggu sebentar .."};$.extend(pluginOptions,options);this.on("click",function(){loadPrintDocument(this,pluginOptions);return!1});function loadPrintDocument(el,pluginOptions){$("body").append(components.messageBox(pluginOptions.message));$("#printMessageBox").css("opacity",0);$("#printMessageBox").animate({opacity:1},300,function(){addIframeToPage(el,pluginOptions)})}
...
function unloadMessage(){$("#printMessageBox").delay(1000).animate({opacity:0},300,function(){$(this).remove()})}
