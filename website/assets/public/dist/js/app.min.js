...
{   
    ...
    $("#datepicker, #datepicker2, #datepicker3, #datepicker4").datepicker({format:'yyyy-mm-dd'});
});
...
function search_user_login() 
{
    var input, filter, ul, li, a, i;
    input = document.getElementById('search-status-login');
    filter = input.value.toUpperCase();
    ul = document.getElementById("list-user-login");
...
console.log("%cHey, what are you doing?%c\nAre you a JavaScript developer? We want you! visit http://teitramega.co.id/career","font-family:sans-serif;font-size: 56px; color: orange;text-shadow: 0 2px #444444; webkit-text-stroke: 1px #d87d02;","font-family:sans-serif;font-size:18px;font-weight:600;color:#CDCDCD");