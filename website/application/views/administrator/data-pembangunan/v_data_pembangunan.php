...
?>			
			<div class="box-body">
				...
				<div class="col-md-3 top">
					  <a href="<?php echo site_url('administrator/data_pembangunan/create') ?>" class="btn btn-success hvr-shadow" style="margin-left: 10px;"><i class="fa fa-plus"></i> Tambah Baru</a>
				</div>
			</div>
			...
			<div class="box-body">
				...
				<div class="col-md-3">
                    ...
                    <a href="<?php echo site_url('administrator/data_pembangunan') ?>" class="btn btn-success hvr-shadow top" style="margin-left: 10px;"><i class="fa fa-times"></i> Reset</a>
				    </div>
				</div>
			...
			<?php	}
				...
				?>
						<tr>
							...
							<a href="<?php echo base_url("administrator/data_pembangunan/status/{$row->id}"); ?>" class="icon-button text-green" data-toggle="tooltip" data-placement="top" title="Status"><i class="fa <?php echo eye_status($row->status); ?>"></i></a>
