...
?>
			<div class="box-body" style="margin-top: 10px;">
				...
				<div class="form-group">
					...
					<select name="lokasi" class="form-control">
                      ...
                      <?php foreach ($this->setting->master_desa() as $key => $value) { ?>
                           <option <?php echo set_select('lokasi', $value->kelurahan_desa); ?> value="<?php echo $value->kelurahan_desa ?>"><?php echo $value->kelurahan_desa ?></option>
                      <?php } ?>
                    </select>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="sasaran" class="form-control" value="<?php echo set_value('sasaran'); ?>">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="volume" class="form-control" value="<?php echo set_value('volume'); ?>">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="dana" class="form-control" value="<?php echo set_value('dana'); ?>">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="sumber" class="form-control" value="<?php echo set_value('sumber'); ?>">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="pola_pelaksanaan" class="form-control" value="<?php echo set_value('pola_pelaksanaan'); ?>">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="penanggung_jawab" class="form-control" value="<?php echo set_value('penanggung_jawab'); ?>">
