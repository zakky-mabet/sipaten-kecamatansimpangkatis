			...
			<div class="box-body" style="margin-top: 10px;">
                ...
                <p class="help-block"><?php echo form_error('tags[]', '<small class="text-red">', '</small>'); ?></p>
              	...
              	<div class="form-group">
					...
					<div class="col-md-8 ">
						 <input type="radio" name="slider" value="yes" <?php echo set_radio('slider','yes');?>  class=" ">&nbsp;&nbsp;YA&nbsp;&nbsp;
	              		<input type="radio" name="slider" value="no" <?php echo set_radio('slider','no');?> class=" ">&nbsp;&nbsp;  TIDAK <br>
