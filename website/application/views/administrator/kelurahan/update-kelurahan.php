			...
			<div class="col-md-6">
				...
				<div class="form-group">
					<label class="control-label">Nama Kelurahan/Desa : <strong class="text-red">*</strong></label>
						<input type="text" name="post[nama_desa]" class="form-control" value="<?php echo $get->nama_desa; ?>">
				...
				<div class="form-group">
					...
					<input type="text" name="post[nama_kades]" class="form-control" value="<?php echo $get->nama_kades; ?>">
				...
				<div class="form-group">
					<label class="control-label">NIP : <strong class="text-red">*</strong></label>
						<input type="text" name="post[nip]" class="form-control" value="<?php echo $get->nip; ?>">
				...
				<div class="form-group">
					<label class="control-label">Pangkat : <strong class="text-red">*</strong></label>
						<input type="text" name="post[pangkat]" class="form-control" value="<?php echo $get->pangkat; ?>">
				...
				<div class="form-group">
					<label class="control-label">Jabatan : <strong class="text-red">*</strong></label>
						<input type="text" name="post[jabatan]" class="form-control" value="<?php echo $get->jabatan; ?>">
				...
				<div class="form-group">
					<label class="control-label">Tempat Lahir : <strong class="text-red">*</strong></label>
						<input type="text" name="post[tmp_lahir]" class="form-control" value="<?php echo $get->tmp_lahir; ?>">
				...
				<div class="form-group">
					<label class="control-label">Tanggal Lahir : <strong class="text-red">*</strong></label>
						<input type="text" name="post[tgl_lahir]" id="datepicker" placeholder="Ex : 1995-12-23" class="form-control" value="<?php echo $get->tgl_lahir; ?>">
				...
				<div class="form-group">
                  <label  class="control-label ">Agama : <span class="text-red">*</span></label>
                    <select name="post[agama]" class="form-control">
                      <option value="<?php echo $get->agama ?>"><?php echo $get->agama ?></option>
            	...
            	<div class="form-group">
					<label class="control-label">Hobi : <strong class="text-red">*</strong></label>
						<input type="text" name="post[hobbi]" class="form-control" value="<?php echo $get->hobbi ?>">
				...
				<div class="form-group">
					<label class="control-label">Motto Hidup Kades : <strong class="text-red">*</strong></label>
						<input type="text" name="post[motto_hidup]" class="form-control" value="<?php echo $get->motto_hidup ; ?>">
				...
				<div class="form-group">
		            <label  class="control-label">Alamat : <span class="text-red">*</span></label>
		              <textarea name="post[alamat]"  placeholder="Ex : Jln. Raya Koba No. 141 RT. 05 Kel. Koba Kecamatan Koba Kabupaten Bangka Tengah" class="form-control"><?php echo $get->alamat;?></textarea>
			...
			<div class="col-md-6">
				...
				<div class="form-group">
					<label class="control-label">Email Kelurahan/Desa : <strong class="text-red">*</strong></label>
						<input type="text" name="post[email_desa]" class="form-control" value="<?php echo $get->email_desa; ?>">
				...
				<div class="form-group">
					<label class="control-label">Alamat Website : <strong class="text-red">*</strong></label>
						<input type="text" name="post[alamat_website]" class="form-control" value="<?php echo $get->alamat_website; ?>">
				...
				<div class="form-group">
					<label class="control-label">Luas Wilayah : <strong class="text-red">*</strong></label>
						<input type="text" name="post[luas_wilayah]" class="form-control" value="<?php echo $get->luas_wilayah; ?>">
				...
				<div class="form-group">
					<label class="control-label">Jumlah RT : <strong class="text-red">*</strong></label>
						<input type="text" name="post[jmlh_rt]" class="form-control" value="<?php echo $get->jmlh_rt; ?>">
				...
				<div class="form-group">
					<label class="control-label">Jumlah RW : <strong class="text-red">*</strong></label>
						<input type="text" name="post[jmlh_rw]" class="form-control" value="<?php echo $get->jmlh_rw; ?>">
				...
				<div class="form-group">
					<label class="control-label">Jumlah Penduduk : <strong class="text-red">*</strong></label>
						<input type="text" name="post[jmlh_penduduk]" class="form-control" value="<?php echo $get->jmlh_penduduk; ?>">
				...
				<div class="form-group">
		            <label  class="control-label">Alamat Kantor :<span class="text-red">*</span></label>
		              <textarea name="post[alamat_kantor]"  placeholder="Ex : Jln. Raya Koba No. 141 RT. 05 Kel. Koba Kecamatan Koba Kabupaten Bangka Tengah" class="form-control"><?php echo $get->alamat_kantor;?></textarea>
		        ...
		        <div class="form-group">
					<label class="control-label">Foto Gedung Kelurahan/Desa : <strong class="text-red">*</strong></label>
						<input type="file" name="foto_kantor" required="required" class="form-control" >
				</div>
