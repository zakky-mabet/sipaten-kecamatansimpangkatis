...
?>
			<div class="box-body" style="margin-top: 10px;">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="periode" class="form-control" value="<?php echo $get->periode; ?>">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
					  <textarea name="sambutan" id="summernote" placeholder="" class="form-control"><?php echo $get->sambutan;?></textarea>
