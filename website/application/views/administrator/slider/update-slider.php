...
?>
			<div class="box-body" style="margin-top: 10px;">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
					<textarea name="short_description" rows="3" class="form-control"><?php echo $get->short_description  ?></textarea>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" placeholder="Ex : http://localhost/website-kec-koba/berita/get/menataplah-terus-kedepan" name="link" class="form-control" value="<?php echo $get->link  ?>">
