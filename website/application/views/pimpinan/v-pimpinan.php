					...
					<p>
						...
						<?php if (!$get_all): ?>
							...
							<div class="alert alert-danger" role="alert">
							  <strong>Hasil Pencarian : <?php echo $this->input->get('query') ?> </strong> <br> Tidak ditemukan di database kami.
							</div>
						<?php else: ?>
							<div class="alert alert-danger" role="alert">
				          ...
				          <div class="col-md-4 col-sm-6 col-xs-12">
				            <div class="team-member">
				              <div class="member-photo" >
				                ...
				                <a href="<?php echo site_url('pimpinan/get/'.$value->slug); ?>" title="<?php echo $value->nama_lengkap ?>"><div class="member-name"><?php echo $value->nama_lengkap ?><span><small>Periode <?php echo $value->periode ?></small></span></div></a>
				              </div>
