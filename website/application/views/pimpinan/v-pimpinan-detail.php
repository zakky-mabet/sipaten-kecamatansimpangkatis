				...
				<div class="row sidebar-page">
					...
					<div class="col-md-9 ">
			           ...
			           <div class="col-md-12">
			           	...
			           	<span class="pull-right"> <i class="fa fa-eye"></i><?php echo  $get->hits ?></span>
			           </div>
					...
					<div class="col-md-3 sidebar right-sidebar">
						...
						<div class="widget widget-popular-posts">
							<h4>Pimpinan Sebelumnya <span class="head-line"></span></h4>
							<ul>
