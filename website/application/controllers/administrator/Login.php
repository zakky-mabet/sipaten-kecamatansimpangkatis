...
class Login extends CI_Controller {
    ...
    public function index()
    {
        ...
        $values = array(
            'word' => '', 
            'word_length' => 4, 
            'img_path' => 'assets/public/captcha/',   
            'img_url' => base_url() .'assets/public/captcha/',
    ...
    public function deleteImage()
    {
        ...
        {
            $lastImage = FCPATH . "assets/public/captcha/" . $this->session->userdata['image'];
    ...
    private function _get_account($param = 0)
    {
        ...
        $query = $this->db->query("
            SELECT * FROM tb_administrator WHERE status='yes' AND username = ?", array($param));
